...
<div>
      <a class="button button-primary full-width" href="/login">Subscribed Channels</a>
      <a class="button full-width" href="/login">Live</a></div>
...
<!-- 
      ...
      @foreach($Videos as $video) 
       ...
       <small href=><a href="/login">1 Comment</a><small></p>
       </span>	
        </div>
...
<!-- 
                    <form id="uploadForm" action="/login" method="post" enctype="multipart/form-data" class="form-horizontal">
@csrf
...
<div> -->
                       ...
                       <a href="/login"> <button  style="float:right" type="submit">Subscribe </button> </a> 
